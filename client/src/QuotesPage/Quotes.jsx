    ...
    <div className='grid grid-cols-4 grid-rows-2'>
      ...
      <div className="flex row-span-2">
        <div className="bg-white dark:bg-gray-800  xl:hidden flex text-gray-800 hover:text-black focus:outline-none focus:text-black justify-between w-full p-6 items-center">
          ...
          <div ariaLabel="toggler" className="flex justify-center items-center">
            <button id="open" onClick="showNav(true)" ariaLabel="open" className="hidden text-gray-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800">
            ...
            <button id="close" onclick="showNav(true)" ariaLabel="close" className="focus:outline-none dark:text-white text-gray-800 focus:ring-2 focus:ring-offset-2 focus:ring-gray-800">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
