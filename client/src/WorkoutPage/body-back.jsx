...
function BodyBack({ handleSearch }) {
  return (
    <svg
      version='1.1'
      id='Layer_1'
      ...
      <g>
        <g>
          <g>
            ...
            />
            <path
              className='st0' // left pinky finger
          ...
          <path
            className='st14'
            onClick={(e) => handleSearch(e, 'glutes')} // left glute
          ...
          <path
            className='st16'
            onClick={(e) => handleSearch(e, 'hamstrings')} // left hamstring
          ...
          <path
            className='st18'
            onClick={(e) => handleSearch(e, 'middle_back')} // left middle back
          ...
          <path
            className='st19'
            onClick={(e) => handleSearch(e, 'lower_back')} // left lower back
        ...
        <g>
          ...
          <path
            className='st14'
            onClick={(e) => handleSearch(e, 'glutes')} // right glute
          ...
          <path
            className='st16'
            onClick={(e) => handleSearch(e, 'hamstrings')} // right hamstring
          ...
          <path
            className='st17'
            onClick={(e) => handleSearch(e, 'calves')} // right calf
          ...
          <path
            className='st18'
            onClick={(e) => handleSearch(e, 'middle_back')} // right middle back
          ...
          <path
            className='st19'
            onClick={(e) => handleSearch(e, 'lower_back')} // right lower back
