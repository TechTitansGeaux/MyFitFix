  ...
  return (
    <div className=' grid grid-cols-5'>
      <div className='flex mb-4 '>
        ...
        <div
          id='Main'
          className='bg-white dark:bg-gray-800  transform xl:translate-x-0 ease-in-out transition duration-500 flex justify-start items-start w-full sm:w-60 flex-col h-full'
        >
          <button className='hidden xl:flex text-gray-800 dark:text-white hover:text-black focus:outline-none focus:text-black justify-start px-6 pt-6 items-center space-x-3 w-full'>
            <svg
              width='34'
            ...
            <img src='https://i.pinimg.com/564x/55/40/de/5540de31482047fb26e188037245b9f8.jpg' />{' '}
            {/* MyFitFix Logo */}
          </button>
      ...
      <div className='col-span-2 mb-4'>
        ...
        <div className='ml-8 max-w-lg h-30 bg-gradient-to-tr from-sky-600 from-10%  via-sky-400 to-sky-50 to-40% ... rounded overflow-hidden shadow-lg row-span-2 '>
          <div className='px-6 py-4'>
            ...
            <div className='min-h-fit' className='search-input'>
              <form>
                <input
                  type='text'
                  placeholder='biceps'
