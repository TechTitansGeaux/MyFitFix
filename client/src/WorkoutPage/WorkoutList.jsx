...
return(
<div className="max-w-xl col-span-2 h-96 rounded overflow-hidden shadow-lg row-span-2 bg-gradient-to-bl from-sky-600 from-10%  via-sky-400 to-sky-50 to-40% ...">
            <div className="px-6 py-4">
              <div className="font-bold text-xl mb-2">Today's Workout</div>
    ...
    <div className="border-r border-b border-l  w-auto overflow-scroll h-60 border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-orange-50 rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
      <div className="mb-8">
      <div className="flex items-center">
            <div className="text-sm">
            <p align='right' className="text-gray-600">{currDate}</p>
            </div>
          </div>
