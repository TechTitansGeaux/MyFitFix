            ...
            <form>
              <label htmlFor='multiLineInput'>
                <textarea
                  rows='15'
                  cols='70'
                  className='shadow-2xl block p-4 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-md focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500'
                  name='entryBox'
                  value={entry}
              ...
              >
                ...
                <span className='inline-block ml-3'>Publish Entry</span>
              </button>
            </form>
          </div>
        </div>
