...
import Goals from "../ProgressGoals/Goals.jsx";
import ProgressDataVisuals from "../ProgressGoals/ProgressDataVisuals.jsx"
...
function Home() {
  ...
  return (
    <div className='grid grid-cols-4 grid-rows-1'>
      ...
      {/* Start of Cards*/}
      {/* MAIN HOME - DASHBOARD */}
      <main className='flex justify-center col-span-2'>
        <div>
          {/* Start of Welcome Title & Image */}
          <div>
            {/* Start of Welcome Title & Image */}
            <div>
              <header className=' font-bold text-4xl inline-block mt-8 flex justify-start text-amber-400'>
                <img
                  className='rounded-full inline-block gap-x-2 h-12 justify-right'
                  src={user.thumbnail}
                  alt='avatar'
                />
                <div className='ml-6'>
            ...
            <div>
              <div className='flex justify-center'>
                ...
                {/* CALORIE INTAKE */}
                <div className='mt-8 mr-2 sm:mx-auto sm:w-full sm:max-w-md  px-10 py-12 rounded-md shadow-lg bg-gradient-to-br from-sky-400 from-10%  via-sky-200 to-sky-100 to-40% ...'>
                  <div className='font-bold text-xl mb-2 hover:text-amber-500'>
                    Calorie Intake
                  </div>
                  <p className='text-gray-700 text-base font-bold '>
                    Today, you have eaten:
                  </p>
                  <p className='text-base font-bold text-amber-500 mt-4 ml-10'>
                    {ateTotal}
                  </p>
                </div>

                {/* CALORIES BURNED */}
                <div className='mt-8 ml-2 sm:w-full sm:max-w-md  px-10 py-12 rounded-md shadow-lg bg-gradient-to-bl from-sky-400 from-10%  via-sky-200 to-sky-100 to-40% ...'>
                  <div className='font-bold text-xl mb-2 hover:text-amber-500'>
                    Calories Burned
                  </div>
                  <p className='text-gray-700 text-base font-bold'>
                  ...
                  <p className='text-base font-bold text-amber-500 mt-4 ml-20'>
                    {dailyBurn} calories
                  </p>
                </div>
              </div>
              ...
              <div className='flex justify-center'>
                ...
                {/* JOURNAL */}
                <div className='mt-8 mr-2 sm:mx-auto sm:w-full sm:max-w-md  px-10 py-12 rounded-md shadow-lg bg-gradient-to-tr from-sky-400 from-10%  via-sky-200 to-sky-100 to-40% ...'>
                  {/* <div className="px-10 py-7 space-x-3"> */}
                  <div className='font-bold text-xl mb-2 inline-block hover:text-amber-500'>
                    Daily Journal Entry
                  </div>
                ...
                {/* WORKOUT PLANNER */}
                <div className='mt-8 ml-2  sm:w-full sm:max-w-md  px-10 py-12 rounded-md shadow-lg bg-gradient-to-tl from-sky-400 from-10%  via-sky-200 to-sky-100 to-40% ...'>
                  <div className='font-bold text-xl mb-2 hover:text-amber-500 inline-block'>
                    Workout Planner
                  </div>
                  {workoutIcon}
