    ...
    axios.get('dashboard/workouts')
      .then(({ data }) => {
        if (data.length !== 0) {
          ...
          setWorkoutIcon(<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" className="inline-block ml-3">
          ...
          setWorkoutIcon(<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 64 64" className="inline-block ml-3" >
    ...
    axios.get(`/journal-entry/${todaysDate}`)
      .then((response) => {
        if (response.data.length !== 0) {
          ...
          setIcon(<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" className="inline-block ml-3">
            <path fill="#27ae60" d="M22 13c0 5.523-4.477 10-10 10S2 18.523 2 13 6.477 3 12 3s10 4.477 10 10z" />
            <path fill="#2ecc71" d="M22 12c0 5.523-4.477 10-10 10S2 17.523 2 12 6.477 2 12 2s10 4.477 10 10z" />
            <path fill="#27ae60" d="m16 9-6 6-2.5-2.5-2.125 2.1 2.5 2.5 2 2 .125.1 8.125-8.1L16 9z" />
            <path fill="#ecf0f1" d="m16 8-6 6-2.5-2.5-2.125 2.1 2.5 2.5 2 2 .125.1 8.125-8.1L16 8z" />
          ...
          setIcon(<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 64 64" className="inline-block ml-3" >
            <path fill="#ffc048" d="M32 3.4A28.59 28.59 0 0 0 3.4 32 28.59 28.59 0 0 0 32 60.6 28.59 28.59 0 0 0 60.6 32 28.59 28.59 0 0 0 32 3.4Zm0 49.2a4.32 4.32 0 1 1 4.31-4.31A4.32 4.32 0 0 1 32 52.6ZM37.23 17 35.6 39a.6.6 0 0 1-.6.56h-6a.6.6 0 0 1-.6-.56l-1.63-22a5.24 5.24 0 1 1 10.46 0Z" data-name="Layer 35" />
          </svg>)
        }
      })
...
{/* 
      ...
      <div className="col-span-2">
        ...
        <div >
          {/* Start of Welcome Title & Image */}
          <div>
            <header className=" font-bold text-4xl inline-block mt-8 flex justify-center text-transparent bg-clip-text bg-gradient-to-r to-orange-500 from-slate-50	ml-20">
              <img className="rounded-full inline-block gap-x-2 h-12 justify-right" src={user.thumbnail} alt="avatar" />
              <div className="ml-6">
              <div className="font-bold text-4xl text-black">Welcome, </div>{user.name}!
              </div>
            </header>
          </div>

          {/* <div className="grid grid-rows-4 grid-flow-col gap-4gap-x-5 justify-center mx-auto mb-5"> */}
          <div>
          ...
          <div className='flex justify-center'>
            ...
            {/* CALORIE INTAKE */}
            <div className="mt-8 mr-2 sm:mx-auto sm:w-full sm:max-w-md  px-10 py-12 rounded-md shadow-lg bg-gradient-to-br from-sky-600 from-10%  via-sky-400 to-sky-100 to-40% ...">
              <div className="font-bold text-xl mb-2 hover:text-orange-500">Calorie Intake</div>
            ...
            {/* CALORIES BURNED */}
            <div className="mt-8 ml-2 sm:w-full sm:max-w-md  px-10 py-12 rounded-md shadow-lg bg-gradient-to-bl from-sky-600 from-10%  via-sky-400 to-sky-100 to-40% ...">
              <div className="font-bold text-xl mb-2 hover:text-orange-500">Calories Burned</div>
              <p className="text-gray-700 text-base font-bold">
          ...
          <div className='flex justify-center'>
            ...
            {/* WORKOUT PLANNER */}
            <div className="mt-8 ml-2  sm:w-full sm:max-w-md  px-10 py-12 rounded-md shadow-lg bg-gradient-to-tl from-sky-600 from-10%  via-sky-400 to-sky-100 to-40% ...">
              <div className="font-bold text-xl mb-2 hover:text-orange-500 inline-block">Workout Planner</div>
              {workoutIcon}
              ...
              <table className="w-full table-fixed">
                ...
                return (
                  <tr key={index}>
                    ...
                    <td className="text-gray-700 text-base font-bold">
                      REPS:{workout.rep}
                    </td>
                  </tr>
                );
