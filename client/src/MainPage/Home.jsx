      ...
      <div className='flex row-span-2'>
        ...
        >
          <button className='hidden xl:flex text-gray-800 dark:text-white hover:text-black focus:outline-none focus:text-black justify-start px-6 pt-6 items-center space-x-3 w-full'>
            ...
            <img src='https://i.pinimg.com/564x/55/40/de/5540de31482047fb26e188037245b9f8.jpg'></img>{' '}
            {/* MyFitFix Logo */}
          </button>
          ...
          <div>
            ...
            <div>
              <header className=' font-bold text-4xl inline-block mt-8 flex justify-center text-transparent bg-clip-text bg-gradient-to-r to-orange-500 from-slate-50	ml-20'>
                ...
                />
                <div className='ml-6'>
                  <div className='font-bold text-4xl text-black'>Welcome, </div>
                  {user.name}!
                </div>
              </header>
            </div>
            ...
            <div>
              ...
              <div className='flex justify-center'>
                ...
                <div className='mt-8 mr-2 sm:mx-auto sm:w-full sm:max-w-md  px-10 py-12 rounded-md shadow-lg bg-gradient-to-tr from-sky-600 from-10%  via-sky-400 to-sky-100 to-40% ...'>
                  ...
                  <div className='font-bold text-xl mb-2 inline-block hover:text-orange-500'>
                    Daily Journal Entry
                  </div>
                ...
                <div className='mt-8 ml-2  sm:w-full sm:max-w-md  px-10 py-12 rounded-md shadow-lg bg-gradient-to-tl from-sky-600 from-10%  via-sky-400 to-sky-100 to-40% ...'>
                  <div className='font-bold text-xl mb-2 hover:text-orange-500 inline-block'>
                    Workout Planner
                  </div>
                  {workoutIcon}
